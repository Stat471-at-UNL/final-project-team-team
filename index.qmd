...
A histogram of `price` shows that the distribution is very right-skewed, as most of the dataset has listings in the \$0-\$1000 price range. In fact only, `r paste0(round(price_group_table$n[2] / nrow(filter_df), 2) * 100, "%")` of the dataset (including NA values) has AirBnB listings over the \$1000 price range.  
