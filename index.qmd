...
ggplot(bed_counts, aes(x = beds, y = n)) +
  ...
  geom_text(                                                # this messes around
    aes(label = n, size = 1/n),                             # with the text on the histogram
    vjust = -0.5,                                           #
    color = "blue",                                         #
    fontface = "bold") +                                    #
  scale_size_continuous(range = c(1.8,3), guide = "none") + # the range determines the size limits
