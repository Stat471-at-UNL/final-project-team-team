...
filter_df %>%
  ...
  select(host_is_superhost, latitude, longitude, accommodates, bathrooms, bedrooms, beds, price) %>% md.pattern(., plot = F) %>%
...
kable(summary_rmse[,-1], digits = 3, format = "latex", booktabs = TRUE)
